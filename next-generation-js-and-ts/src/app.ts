...
const personCopied = {...person}; //U remember that assigning will make the variable point to the same memory location, not copoing.
...
const add = (n1:number, n2:number, ...n3:number[]) =>{
